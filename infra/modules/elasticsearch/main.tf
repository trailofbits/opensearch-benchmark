  ...
  user_data = templatefile("${path.module}/es-cluster.yaml",
    {
      ...
      jvm_options_8          = yamlencode(base64gzip(file("${path.module}/jvm.v8.options"))),
      jvm_options_9          = yamlencode(base64gzip(file("${path.module}/jvm.v9.options"))),
  ...
  user_data = templatefile("${path.module}/es-load-generation.yaml",
    {
      ...
      osb_knn_patch_1_12_0    = yamlencode(base64gzip(file("${path.module}/es_files/osb-1.12.0-knn.patch"))),
      vectorsearch_task_patch_1_12_0 = yamlencode(base64gzip(file("${path.module}/../common_files/vectorsearch-task-1.12.0.patch"))),
